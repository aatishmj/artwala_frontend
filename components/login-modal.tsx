  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-center text-stone-900">Welcome Back</DialogTitle>
          <p className="text-center text-stone-600">Sign in to your Mud & Art account</p>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button variant="link" className="text-amber-700 hover:text-amber-800 p-0 h-auto">
              Forgot password?
            </Button>
          </div>
        ...
        <div className="text-center">
          ...
          <Button variant="link" className="text-amber-700 hover:text-amber-800 p-0 h-auto" onClick={onSwitchToSignup}>
            Sign up
          </Button>
        </div>
      </DialogContent>
